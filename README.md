...
This project is about biodiversity in national parks and has data from the National Parks Service about endangered species in different parks.
...
Some components to  be discussed in this project include:
